        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container">
                <a class="navbar-brand" href="#">
                    <img src="img/Logo.png" alt="Logo" width="100px" height="auto">
                </a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    data-bs-target="#navbarPrimaryMenu" aria-controls="navbarPrimaryMenu" aria-expanded="false"
                    ...
                    <div class="col-4 col-md-2 col-lg-4 col-xl-3">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="#" class="btn btn-primary">Đến mua ngay</a>
                            </div>
                        </div>
                    </div>
                <?php endfor; ?>
